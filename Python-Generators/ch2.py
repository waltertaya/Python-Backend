...
# no_whitespaces = (string.strip(" ") for string in data)
no_whitespaces = (string.replace(" ", "") for string in data)
data_len = (len(string) for string in no_whitespaces)

less_than = (num for num in data_len if num < 130)
